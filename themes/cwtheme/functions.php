<?php
/**
 * cwTheme functions and definitions.
 *
...
if ( ! function_exists( 'cwtheme_setup' ) ) :
/**
 ...
 */
function cwtheme_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on cwTheme, use a find and replace
	 * to change 'cwtheme' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'cwtheme', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'cwtheme' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'cwtheme_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'cwtheme_setup' );
 ...
 */
function cwtheme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'cwtheme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'cwtheme' ),
